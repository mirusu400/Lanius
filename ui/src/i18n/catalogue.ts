...
const en = {
  ...
  'appearance.uiSizePresets': 'Common interface sizes',
  'appearance.monoSizePresets': 'Common editor sizes',
...
const ko: Catalogue = {
  ...
  'appearance.uiSizePresets': '자주 쓰는 인터페이스 크기',
  'appearance.monoSizePresets': '자주 쓰는 편집기 크기',
